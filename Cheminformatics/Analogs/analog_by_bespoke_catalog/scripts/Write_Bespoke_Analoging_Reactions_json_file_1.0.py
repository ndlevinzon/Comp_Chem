...
# Takes input file of reactions and creates a JSON file with their associated SMARTS
...
# Commenting out 'Append' features to help with making Append script for future versions
...
Analoging_Reactions_Map = {} # Create the Master Map dictionary
Analoging_Reactions_Map["Reactions"] = {} # Comment out for APPEND script

#rxn_IDs_list = Analoging_Reactions_Map["Reaction_IDs"] # For Append script
rxn_IDs_list = [] # Have a list of all breakdown rxn IDs
...
outfile_name = reactions_input_filename + ".json"
