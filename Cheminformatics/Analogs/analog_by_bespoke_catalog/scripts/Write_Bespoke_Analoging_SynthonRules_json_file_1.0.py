...
# Takes input file of reactions and building block class types with their inSMARTS and exSMARTS, 
# Associates each reaction with the building blocks it can take,
# writes them to a json file to be used as the input for analog_breakdownrxns script
...
# Including commented-out 'Append' script lines to help with making Append script for future versions (just modify and uncomment!)
...
# Write out the Synthon_Map to a JSON file
#outfile_name = appended_json_file_name + ".json" # For Append script
outfile_name = synthon_rules_input_filename + ".json"
